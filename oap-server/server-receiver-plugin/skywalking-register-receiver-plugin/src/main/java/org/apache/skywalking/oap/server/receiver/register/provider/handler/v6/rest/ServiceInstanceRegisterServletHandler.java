    ...
    protected JsonElement doPost(HttpServletRequest req) throws ArgumentsParseException {
        ...
        try {
            ...
            for (int i = 0; i < instanceList.size(); i++) {
                ...
                List<KeyStringValuePair> propertiesList = gson.fromJson(instance.get(INSTANCE_PROPERTIES).getAsString(), TypeToken.getParameterized(List.class, KeyStringValuePair.class).getType());
